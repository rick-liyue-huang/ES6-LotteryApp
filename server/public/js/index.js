	  ...
	  _createClass(Base, [{
	    ...
	    value: function initPlayList() {
	      this.play_list.set('r2', {
	        bonus: 6,
	        tip: 'Select 2 different number from 01～11, if match all numbers with the result, will win $<em class="red">6.00</em>',
	        name: 'Option 2'
	      }).set('r3', {
	        bonus: 19,
	        tip: 'Select 3 different number from 01～11, if match all numbers with the result, will win $<em class="red">19.00</em>',
	        name: 'Option 3'
	      }).set('r4', {
	        bonus: 78,
	        tip: 'Select 4 different number from 01～11, if match all numbers with the result, will win $<em class="red">78.00</em>',
	        name: 'Option 4'
	      }).set('r5', {
	        bonus: 540,
	        tip: 'Select 5 different number from 01～11, if match all numbers with the result, will win $<em class="red">540.00</em>',
	        name: 'Option 5'
	      }).set('r6', {
	        bonus: 90,
	        tip: 'Select 6 different number from 01～11, if match 5 numbers with the result, will win $<em class="red">90.00</em>',
	        name: 'Option 6'
	      }).set('r7', {
	        bonus: 26,
	        tip: 'Select 7 different number from 01～11, if match 5 numbers with the result, will win $<em class="red">26.00</em>',
	        name: 'Option 7'
	      }).set('r8', {
	        bonus: 9,
	        tip: 'Select 9 different number from 01～11, if match 5 numbers with the result, will win $<em class="red">9.00</em>',
	        name: 'Option 8'
	      });
	    }
	    /**
	    ...
	    value: function addCodeItem(code, type, typeName, count) {
	      var self = this;
	      var tpl = '\n    <li codes="' + type + '|' + code + '" bonus="' + count * 2 + '" count="' + count + '">\n\t\t <div class="code">\n\t\t\t <b>' + typeName + (count > 1 ? ' Multiple' : ' Single') + '</b>\n\t\t\t <b class="em">' + code + '</b>\n\t\t\t [' + count + 'group,$<em class="code-list-money">' + count * 2 + '</em>]\n\t\t </div>\n\t </li>\n    ';
	    ...
	    value: function getCount() {
	      ...
	      if (count === 0) {
	        tpl = 'You select <b class="red">' + count + '</b> Group\uFF0CTotal $<b class="red">' + count * 2 + '</b> ';
	      } else if (range[0] === range[1]) {
	        tpl = 'You select <b>' + count + '</b> Group\uFF0CTotal $<b>' + count * 2 + '</b>   <em>if win\uFF0CBonus:\n\t\t\t$<strong class="red">' + range[0] + '</strong> ,\n\t\t\tYou will' + (win1 >= 0 ? 'win' : 'loss') + '\n\t\t\t$<strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + Math.abs(win1) + ' </strong> </em>';
	      } else {
	        tpl = 'You select <b>' + count + '</b> Group\uFF0CTotal $<b>' + count * 2 + '</b>   <em>if win\uFF0CBonus:\n\t\t\t<strong class="red">' + range[0] + '</strong> to $<strong class="red">' + range[1] + '</strong> ,\n\t\t\tYou will{(win1<0&&win2<0)?\'loss\':\'win\'}\n\t\t\t<strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + ' </strong>\n\t\t\tto $<strong class="' + (win2 >= 0 ? 'red' : 'green') + '"> ' + c2 + ' </strong>\n\t\t\t</em>';
	      }
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	  ...
	  _createClass(Calculate, [{
	    ...
	    /**
	     * [computeCount how many groups]
	     * @param  {number} active    [currently select numbers]
	     * @param  {string} play_name [currently play name]
	    ...
	    /**
	     * [computeBonus bonus calculate]
	     * @param  {number} active    [currently select numbers]
	     * @param  {string} play_name [currently play name]
	     * @return {array}           [bonus arrange]
	     */
	    ...
	    /**
	     * [combine ]
	     * @param  {array} arr  [the groups]
	     * @param  {number} size [base size]
	     * @return {number}      [group numbers]
	     */
